...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    ...
    <label class:checked={opts.pausable}>
      ...
      >
        Privileged accounts will be able to pause the functionality marked as <code
          >whenNotPaused</code
    ...
    <label class:checked={opts.permit || opts.votes}>
      ...
      >
        Without paying gas, token holders will be able to allow third parties to
        transfer from their account.
      </HelpTooltip>
    </label>
...
<section class="controls-section">
  ...
  <label class="labeled-input">
    <span class="flex justify-between pr-2">
      Limit
      <HelpTooltip
        >Token activity is limited to certain amounts per day.</HelpTooltip
      >
    </span>
    <input
...
<section class="controls-section">
  <h1>
    ...
    <label class="flex items-center tooltip-container pr-2">
      ...
      <HelpTooltip
        align="right"
        link="https://docs.openzeppelin.com/contracts/api/token/erc20#ERC20Votes"
      >
  ...
  <div class="checkbox-group">
    <label class:checked={opts.votes === "blocknumber"}>
      ...
      Block Number
      <HelpTooltip
        link="https://docs.openzeppelin.com/contracts/governance#governor"
      >
    ...
    <label class:checked={opts.votes === "timestamp"}>
      ...
      Timestamp
      <HelpTooltip
        link="https://docs.openzeppelin.com/contracts/governance#timestamp_based_governance"
      >
